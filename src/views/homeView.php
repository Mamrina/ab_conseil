  ...
  <section>
    <div class="img-rhune" id="title-cover">
      ...
      <div class="text-over-image">
        ...
        <a id="button-light" class="button animate__animated animate__fadeInUp" href="<?= $router->generate('schedules'); ?>">me contacter</a>
        <a id="button-light" class="button animate__animated animate__fadeInUp" href="<?= $router->generate('about_me'); ?>">qui suis-je ?</a>
      </div>
    </div>
  </section>
  <section class="wrapper">
    ...
    <div class="background-text">
      <div class="formatting-text">
        <p class="bold-italic animate__animated animate__slideInLeft">Mon accompagnement se fonde sur 3 axes principaux : </p>
