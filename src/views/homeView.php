...
<main>
  <section>
    <div class="img-rhune" id="title-cover">
      ...
      <div class="text-over-image">
        ...
        <p>Consultante RH</p>
        <p>Bilan de compétences & Formation professionnelle</p>
        <a class="button" href="<?= $router->generate('schedules'); ?>">me contacter</a>
        <a class="button" href="<?= $router->generate('about_me'); ?>">qui suis-je ?</a>
      </div>
    </div>
  </section>
  ...
  <section class="wrapper">
    <div class="formatting-text block-color">
      <p class="bold-italic">Accessibilité aux personnes handicapées</p>
